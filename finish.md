    ...
    <div class="container px-4 py-2">
     <div class="row g-4 py-2 row-cols-1 row-cols-lg-1">
      <div class="feature col div-choice">
        ...
        <ul>
              <li><span class="scenario-objective">Main characteristics and benefits of Apache Cassandra</span></li>
              <li><span class="scenario-objective">Installing, starting and connecting to a Cassandra instance</span></li>
        </ul>
